...
- [ ] 4. Checkpoint - Проверить базовую структуру
...
- [ ] 5. Проверить и настроить интерактивность
  ...
  - [ ] 5.5 Проверить анимации при загрузке страницы
...
- [ ] 7. Checkpoint - Проверить функциональность
  - Протестировать все hover-эффекты
  - Протестировать все breakpoints
  - Убедиться, что анимации работают плавно
  - Спросить пользователя, если возникли вопросы

- [ ] 8. Проверить сохранение данных и контента
  - [ ] 8.1 Проверить заголовки и подзаголовки
  ...
  - [ ] 8.2 Проверить данные всех 10 штатов
  ...
  - [ ] 8.4 Проверить данные карточек статистики
...
- [ ] 10. Удалить раздел статистики с главной страницы
  - [ ] 10.1 Создать backup index.html
