...
export default function Footer() {
    const footerLinks = {
        'Курс': [
            { name: 'Программа обучения', href: '/course' },
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
                    ...
                    <div className="lg:col-span-2">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-black text-white">Dispatcher Training</span>
                        </Link>
                        <p className="text-gray-400 mb-6 max-w-sm">
                            Профессиональное обучение диспетчеров грузоперевозок.
                            Помогаем начать карьеру и зарабатывать удаленно.
                        </p>
                        <div className="flex gap-4">
                            ...
                            <a href="https://t.me/dispatcher_training" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors">
                                <svg className="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
