...
allScenarios.push(...allScenariosV4);
console.log('✅ Диалоги v4 добавлены. Всего диалогов:', allScenarios.length);
console.log('🔍 Последний добавленный диалог:', allScenarios[allScenarios.length - 1]);
